...
export default function App() {
  ...
  var setShouldShowArray = [setShouldShow1, setShouldShow2, setShouldShow3, setShouldShow4, setShouldShow5, setShouldShow6, setShouldShow7, setShouldShow8, setShouldShow9]
  ...
  function hideAllbars() {
    for (var i =0; i < setShouldShowArray.length; i++){
  ...
  function retryLevel(){
    ...
    var thisLevel = parseInt(LivelloMostrato);
